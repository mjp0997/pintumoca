...
<div class='row'>
   <div class='col-12 col-md-9'>
      <form class="card" action="{{ route('products.mass-read') }}" method="POST" enctype="multipart/form-data">
         ...
         <input type='hidden' name='route' value="mass-edit">

         <div class="card-header">
            <h3 class="card-title">Cargar stock entrante</h3>
         </div>
      ...
      @if (session('products'))
         <form class="card" action="{{ route('products.mass-update') }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class='card-footer'>
               <div class='d-flex justify-content-end'>
                  <button type="submit" class="btn btn-primary">Actualizar stocks</button>
               </div>
            </div>
         </form>
      @endif
